...
class TrackingSampler(torch.utils.data.Dataset):
    ...
    def __len__(self):  # 通过这个函数来控制每个epoch取的batch数量
    ...
    def getitem(self):
        ...
        while not valid:
            ...
            # visible是每一帧是否存在目标，seq_info_dict是数据集给每帧的attr标注
            ...
            if is_video_dataset:
                ...
                if self.frame_sample_mode == 'causal':
                    ...
                    while search_frame_ids is None:
                        ...
                        prev_frame_ids = self._sample_visible_ids(visible, num_ids=self.num_template_frames - 1, min_id=base_frame_id[0] - self.max_gap - gap_increase, max_id=base_frame_id[0])
            ...
            try:
                # 从dataset文件（e.g. train/dataset/lasot.py）中调用get_frames方法，返回帧、box标签、meta信息
    ...
    def getitem_cls(self):
        # get data for classification，即stage2训练
        """
        args:
    ...
    def sample_seq_from_dataset(self, dataset, is_video_dataset):
        ...
        while not enough_visible_frames:
            ...
            # Sample frames
            # 只取能看到target的帧，当总数>2*（num_template + num_search），且>20，才取这条视频
