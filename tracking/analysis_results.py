...
trackers = []
dataset_name = 'lasot'  # got10k_test
"""stark"""
# trackers.extend(trackerlist(name='stark_s', parameter_name='baseline', dataset_name=dataset_name, run_ids=None, display_name='STARK-S50'))
trackers.extend(trackerlist(name='stark_st', parameter_name='baseline_got10k_only', dataset_name=dataset_name, run_ids=None, display_name='STARK-ST50'))
"""TransT"""
